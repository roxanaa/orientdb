...
public class OLongSerializer implements OBinarySerializer<Long> {
  ...
  @Override
  public Long deserializeFromDirectMemoryObject(ODirectPointerWrapper wrapper, long offset) {
  ...
  public long deserializeFromDirectMemory(final ODirectPointerWrapper wrapper, final long offset) {
    return wrapper.getLong(offset);
  }
