...
public class OFloatSerializer implements OBinarySerializer<Float> {
  ...
  @Override
  public Float deserializeFromDirectMemoryObject(ODirectPointerWrapper wrapper, long offset) {
  ...
  public float deserializeFromDirectMemory(ODirectPointerWrapper wrapper, final long offset) {
    return Float.intBitsToFloat(wrapper.getInt(offset));
  }
