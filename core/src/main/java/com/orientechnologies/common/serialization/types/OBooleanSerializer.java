...
public class OBooleanSerializer implements OBinarySerializer<Boolean> {
  ...
  @Override
  public Boolean deserializeFromDirectMemoryObject(ODirectPointerWrapper wrapper, long offset) {
  ...
  public boolean deserializeFromDirectMemory(ODirectPointerWrapper wrapper, long offset) {
    return wrapper.getByte(offset) > 0;
  }
