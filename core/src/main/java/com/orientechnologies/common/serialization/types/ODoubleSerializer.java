...
public class ODoubleSerializer implements OBinarySerializer<Double> {
  ...
  @Override
  public Double deserializeFromDirectMemoryObject(ODirectPointerWrapper wrapper, long offset) {
  ...
  public double deserializeFromDirectMemory(ODirectPointerWrapper wrapper, final long offset) {
    return Double.longBitsToDouble(wrapper.getLong(offset));
  }
