...
public class OByteSerializer implements OBinarySerializer<Byte> {
  ...
  @Override
  public Byte deserializeFromDirectMemoryObject(ODirectPointerWrapper wrapper, long offset) {
  ...
  public byte deserializeFromDirectMemory(final ODirectPointerWrapper wrapper, final long offset) {
    return wrapper.getByte(offset);
  }
