...
public interface OBinarySerializer<T> {
  ...
  T deserializeFromDirectMemoryObject(ODirectPointerWrapper wrapper, long offset);

  int getObjectSizeInDirectMemory(ODirectPointerWrapper wrapper, long offset);
