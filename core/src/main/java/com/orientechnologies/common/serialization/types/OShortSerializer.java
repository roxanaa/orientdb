...
public class OShortSerializer implements OBinarySerializer<Short> {
  ...
  @Override
  public Short deserializeFromDirectMemoryObject(ODirectPointerWrapper wrapper, long offset) {
  ...
  public short deserializeFromDirectMemory(ODirectPointerWrapper wrapper, long offset) {
    return wrapper.getShort(offset);
  }
